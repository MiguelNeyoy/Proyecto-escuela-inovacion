    ...
    <div className="flex min-h-screen flex-col bg-background-light dark:bg-background-dark font-grotesk">
      ...
      <main className="flex-1 px-4 py-3">
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          ...
          <InputGroup label="Email Address" placeholder="john.doe@email.com" />
          <InputGroup label="Password" placeholder="Enter your password" type="password" />
          <InputGroup label="Confirm Password" placeholder="Confirm your password" type="password" />
