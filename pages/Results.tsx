...
const ResultItem: React.FC<{ title: string, desc: string, price: string, availability: string, img: string }> = ({ title, desc, price, availability, img }) => (
  <div className="flex cursor-pointer gap-4 rounded-xl bg-white p-3 dark:bg-card-dark/50 hover:shadow-md transition-shadow">
