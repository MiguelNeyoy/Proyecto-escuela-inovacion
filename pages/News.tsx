...
const NewsCard: React.FC<{ source: string, time: string, title: string, desc: string, img: string }> = ({ source, time, title, desc, img }) => (
  <div className="flex cursor-pointer gap-4 rounded-xl bg-white dark:bg-card-dark p-4 shadow-sm hover:shadow-md transition-shadow">
