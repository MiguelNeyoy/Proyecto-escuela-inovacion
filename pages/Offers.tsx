...
const Offers: React.FC = () => {
  ...
  return (
    <PageContainer className="min-h-screen flex flex-col font-body bg-background-light dark:bg-background-dark">
      <TopBar 
        title="Ofertas" 
      ...
      <div className="flex gap-2 px-4 pb-4 overflow-x-auto no-scrollbar animate-slide-in-down" style={{ animationDelay: '0.1s' }}>
...
const OfferCard: React.FC<{ title: string, price: string, oldPrice: string, discount: string, img: string, visible: boolean, index: number }> = ({ title, price, oldPrice, discount, img, visible, index }) => (
  <div className="flex flex-col gap-2 group cursor-pointer" style={{
